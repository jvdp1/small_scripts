...
"	hi mText	term=NONE cterm=NONE ctermfg=White ctermbg=Black gui=bold guifg=Black guibg=White
	...
	hi sComment	term=bold cterm=NONE ctermfg=Green ctermbg=Cyan gui=NONE guifg=DarkGreen guibg=White
	hi sCard	term=bold cterm=NONE ctermfg=Black ctermbg=Yellow gui=NONE guifg=Black guibg=LightYellow
	hi sDate_Time	term=NONE cterm=bold ctermfg=Green ctermbg=NONE gui=bold guifg=SeaGreen guibg=White
	hi sKeyword	term=NONE cterm=NONE ctermfg=Blue  ctermbg=NONE gui=NONE guifg=Blue guibg=White
	hi sFmtInfmt	term=NONE cterm=NONE ctermfg=LightGreen ctermbg=NONE gui=NONE guifg=SeaGreen guibg=White
	hi sString	term=NONE cterm=NONE ctermfg=Magenta ctermbg=NONE gui=NONE guifg=Purple guibg=White
	hi sText	term=NONE cterm=NONE ctermfg=White ctermbg=NONE gui=bold guifg=Black guibg=White
	hi sNumber	term=NONE cterm=bold ctermfg=Darkmagenta ctermbg=NONE gui=bold guifg=SeaGreen guibg=White
	hi sProc	term=NONE cterm=bold ctermfg=Blue ctermbg=NONE gui=bold guifg=Navy guibg=White
	hi sSection	term=NONE cterm=bold ctermfg=Blue ctermbg=NONE gui=bold guifg=Navy guibg=White
	hi mDefine	term=NONE cterm=bold ctermfg=White ctermbg=NONE gui=bold guifg=Black guibg=White
	hi mKeyword	term=NONE cterm=NONE ctermfg=Blue ctermbg=NONE gui=NONE guifg=Blue guibg=White
	hi mReference	term=NONE cterm=bold ctermfg=White ctermbg=NONE gui=bold guifg=Blue guibg=White
	hi mSection	term=NONE cterm=NONE ctermfg=Blue ctermbg=NONE gui=bold guifg=Navy guibg=White
	hi mText	term=NONE cterm=NONE ctermfg=White ctermbg=NONE gui=bold guifg=Black guibg=White
